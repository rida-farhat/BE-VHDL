...
add_fileset_file avalon_pwm.vhd VHDL PATH output_files/avalon_pwm.vhd TOP_LEVEL_FILE
...
add_interface_port conduit_end out_pwm writeresponsevalid_n Output 1
