...
`timescale 1 ps / 1 ps
module button_mm_interconnect_0 (
	...
	wire   [4:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> cpu_data_master_agent:rp_channel
	...
	wire   [4:0] rsp_mux_001_src_channel;                                                   // rsp_mux_001:src_channel -> cpu_instruction_master_agent:rp_channel
	...
	wire   [4:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> cpu_debug_mem_slave_agent:cp_channel
	...
	wire   [4:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> ram_s1_agent:cp_channel
	...
	wire  [16:0] button_s1_agent_m0_address;                                                // Button_s1_agent:m0_address -> Button_s1_translator:uav_address
	...
	wire  [93:0] button_s1_agent_rf_source_data;                                            // Button_s1_agent:rf_source_data -> Button_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] button_s1_agent_rsp_fifo_out_data;                                         // Button_s1_agent_rsp_fifo:out_data -> Button_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> Button_s1_agent:cp_data
	...
	wire         button_s1_agent_rp_valid;                                                  // Button_s1_agent:rp_valid -> router_005:sink_valid
	wire  [92:0] button_s1_agent_rp_data;                                                   // Button_s1_agent:rp_data -> router_005:sink_data
	wire         button_s1_agent_rp_ready;                                                  // router_005:sink_ready -> Button_s1_agent:rp_ready
	wire         button_s1_agent_rp_startofpacket;                                          // Button_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         button_s1_agent_rp_endofpacket;                                            // Button_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	button_mm_interconnect_0_router router (
	...
	button_mm_interconnect_0_router router_001 (
	...
	button_mm_interconnect_0_router_002 router_002 (
	...
	button_mm_interconnect_0_router_002 router_003 (
	...
	button_mm_interconnect_0_router_002 router_004 (
	...
	button_mm_interconnect_0_router_002 router_005 (
	...
	button_mm_interconnect_0_router_002 router_006 (
	...
	button_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (jtag_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (jtag_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	button_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
